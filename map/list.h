...
void list_append(list_t *list, shelf*address);

/// Inserts a new element at the end of the list
///
/// \param list pointer to the list
/// \param elem the integer to be prepended
void list_prepend(list_t *list, shelf*address);
...
bool list_insert(list_t *list, int index, shelf*address);
...
bool list_remove(list_t *list, int index, shelf*address);
...
char *list_first(list_t *list);

/// A convenience for list_get(list, -1)
char* list_last(list_t *list);
